...
<template>
  <div
    ...
    class="relative border border-solid overflow-hidden border-gray-300 p-[7px] w-full max-w-[380px] rounded-[10px] duration-300 cursor-pointer z-20 hovered"
  >
    <div class="relative">
    ...
    <div class="content mx-[20px] mb-[24px]">
      <div class="mt-[28px] pb-[18px] border-b border-solid border-gray-300">
        <h3 class="text-[22px] font-medium leading-[24.2px]">{{ props.data.title }}</h3>
      </div>
      <div class="flex flex-col gap-[22px] mt-[19px]">
        <div class="flex flex-row justify-between">
          <p class="text-base font-normal">Лот:</p>
        ...
        <div class="text-base font-normal flex flex-row justify-between">
          <p>Город:</p>
      ...
      <button
        ...
        class="absolute -bottom-[60px] left-0 mt-[31px] bg-primary w-full max-w-[320px] h-[38px] text-base font-normal duration-300 text-white rounded-md hover:bg-primary/70"
      >
