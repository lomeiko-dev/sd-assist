...
<template>
  <div class="flex flex-col gap-[7px]">
    ...
    <div class="bg-white rounded-[10px] w-full h-[200px] p-[26px]">
      ...
      <div class="p-[12px] border border-solid border-primary/20 rounded-[10px] flex flex-row mt-4">
        <button
          @click="dicrementValue"
          class="border-r border-solid border-r-primary/20 pr-[22px] pl-[10px] text-[26px]"
        >
          -
        </button>
        <InputNumber
          :min="minBid"
          class="input-price w-full text-[26px] font-bold text-primary"
          v-model="value"
          inputId="integeronly"
        ...
        <button
          ...
          class="border-l border-solid border-l-primary/20 pl-[22px] pr-[10px] text-[26px]"
        >
          +
        </button>
      </div>
